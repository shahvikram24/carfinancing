...
function CurrentServer() {
    ...
    if((isset($ForceLive) && $ForceLive) || $_SERVER['SERVER_NAME'] == "www.carfinancing.help" || $_SERVER['SERVER_NAME'] == "carfinancing.help")
        return "live";
    else if((isset($ForceLivestage) && $ForceLivestage) || $_SERVER['SERVER_NAME'] == "carfinancing.vstudiozzz.com")
        return "vstudiozzz";
    else
        return "local";
}
