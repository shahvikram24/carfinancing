...
class Files extends  BaseClass {
    ...
    public function LoadFileInfo($ContactId) {
        if(NumberCheck($ContactId)) {
            $SQL = "SELECT F.* FROM tblfile F 
                    JOIN tblfilerelations FR ON FR.FileId = F.Id 
                    WHERE FR.ContactId= " . $ContactId;
    ...
    public function FileuploadCount($ContactId) {
    ...
    public function LoadCreditScore($ContactId) {
        if(NumberCheck($ContactId)) {
            $SQL = "SELECT F.* FROM tblfile F 
                    JOIN tblfilerelations FR ON FR.FileId = F.Id 
                    WHERE F.FileName = 'Credit Report' AND FR.ContactId= " . $ContactId;
