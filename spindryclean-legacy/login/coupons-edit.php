<?php 
	...
	if(!isset($CouponId))
	{
		header('Location:coupons.php?'.$Encrypt->encrypt("Success=False&Message=Invalid Coupon"));
		exit();
	}	
	...
	if(isset($_POST['couponedit']) && $_POST['couponedit'] == 'couponedit')
	{
		...
		if($coupon->updateCoupon())
		{
			header('Location:coupons.php?'.$Encrypt->encrypt("Success=True&Message=Success: You have modified the coupon!"));
			exit();
		}
		else
		{
		         ...
		         <div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="x_panel">
		                  <div class="x_title">
		                    ...
		                    <h2> Edit Coupon <small>Manage your coupon here</small></h2>
