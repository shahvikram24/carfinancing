...
function CurrentServer() {
    ...
    if((isset($ForceLive) && $ForceLive) || $_SERVER['SERVER_NAME'] == "www.spindryclean.com" || $_SERVER['SERVER_NAME'] == "spindryclean.com")
        return "live";
    else if((isset($ForceLivestage) && $ForceLivestage) || $_SERVER['SERVER_NAME'] == "spindryclean.vstudiozzz.com")
        return "vstudiozzz";
    else
        return "local";
}
