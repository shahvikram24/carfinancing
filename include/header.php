<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="index.php" class="site_title"><span>CAR FINANCING</span></a>
    </div>
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-edit"></i> Orders <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="onetimepickup.php">Schedule A Pickup</a></li>
              <li><a href="orderhistory.php">Order History</a></li>
            </ul>
          </li>
          <li><a><i class="fa fa-cogs"></i> Account <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="accountedit.php">Edit Profile</a></li>
