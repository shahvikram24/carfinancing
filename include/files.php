<?php 
		...
		if(isset($_SERVER['SERVER_NAME']) && ($_SERVER['SERVER_NAME'] == "carfinancing.help" || $_SERVER['SERVER_NAME'] == "www.carfinancing.help"))
			require_once("/var/www/vhosts/carfinancing/httpdocs/lib/constants.php");
		else if(isset($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == "carfinancing.vstudiozzz.com")
			require_once("/var/www/vhosts/vstudiozzz.com/carfinancing.vstudiozzz.com/members/lib/constants.php");
		else
			require_once("C:/AppServ/www/carfinancing/lib/constants.php");
