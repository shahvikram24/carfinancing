...
<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="index.php" class="site_title"><span>Car Financing Help</span></a>
    </div>
      ...
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-cogs"></i> Leads Generation <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="referral-code.php">Referral Code</a></li>
              <li><a href="lead-tracking.php">Lead Tracking</a></li>
              <li><a href="manual-leads.php">Send Leads Manually</a></li>
            </ul>
          </li>
