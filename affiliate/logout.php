<?php
	...
	session_destroy();
  header('Location:login.php?'.$Encrypt->encrypt("Success=True&Message=You have successfully logged out from the system."));
      exit();
?>
...
<title>Car Financing Help | Affiliate Referral Program</title>
