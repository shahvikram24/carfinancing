<?php 
  ...
  if(isset($_REQUEST['request']) && $_REQUEST['request'] == 'request')
  {
    ...
    $support = new Support();
    $support->AffiliateId = $affiliate->affiliate_id;
    ...
    $support->addSupport();
        ...
        $message .= "<tr><td style='background: #eee;'><strong>Business Name:</strong> </td><td>" . $business . "</td></tr>";
    ...
    if (mail(ADMINEMAIL, 'Support Request From Affiliate' , $message, $headers)) {
