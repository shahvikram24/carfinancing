<?php
    ...
    if(isset($_POST['signup']) && $_POST['signup'] == 'Register')
    {
                ...
                //$affiliate->commission = $_POST['commission'];
                ...
                if($_POST['Referral'] !='' && isset($_POST['Referral']))
                {
                    $superAffiliate = new SuperAffiliate();
                    $superAffiliate->loadAffiliate("code like '".$_POST['Referral'] . "'");

                    $affiliateTransaction = new SuperAffiliateTransaction();
                    $affiliateTransaction->superaffiliateid = $superAffiliate->superaffiliate_id;
                    $affiliateTransaction->affiliateid = $affiliateId;
        ...
        <div class="container">
            <form method="post" action="#">
                            ...
                            <div id="login-form" class="login-form">
                                <input type='hidden' name='Referral' value='<?= $Decrypt->decrypt($path_info['query']); ?>' />
                                 <h3>Personal&nbsp;Info</h3>
                                    <div class="full">
                                        <div class="col-sm-6">
