...
if(isset($_SERVER['SERVER_NAME']) && ($_SERVER['SERVER_NAME'] == "SupeCarLoans.ca" || $_SERVER['SERVER_NAME'] == "www.SupeCarLoans.ca"))
    define('BASE_DIR','/var/www/vhosts/SupeCarLoans.ca/httpdocs/img/');
else if(isset($_SERVER['SERVER_NAME']) && $_SERVER['SERVER_NAME'] == "supercarloans.vstudiozzz.com")
    define('BASE_DIR','/var/www/vhosts/vstudiozzz.com/supercarloans.vstudiozzz.com/img/');
else
    define('BASE_DIR','C:/AppServ/www/supercarloans/img/');


// Get real file name.
// Remove any path info to avoid hacking by adding relative path, etc.
$filePath = BASE_DIR.$_GET['f'];
...
{     
    ...
    { 
        ...
        { 
            ...
            $chunksize = 128 * (1024 * 1024); //128MB (highest possible fread length) 
            if ($size > $chunksize) 
            { 
