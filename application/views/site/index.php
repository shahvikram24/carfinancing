<div class="container">
	...
	<!-- Mobile Car Slider -->
		...
		<a id="item-title-slick" class="link vehicle-select-btn" href="<?php echo Yii::$app->urlManager->createUrl('online-car-loan-application'); ?>" data-method="POST" data-params="{'vehicle': 'sedan'}" style="opacity: 1;">I Want a Sedan</a>
                    </div>
...
<div class="vehicle-picker-container not-animating hidden-xs hidden-sm">
	...
	<div class="vehicle-select-container text-center hidden-xs hidden-sm">
		<a id="item-title" class="link vehicle-select-btn" href="<?php echo Yii::$app->urlManager->createUrl('online-car-loan-application') ;?>" data-method="POST" data-params="{'vehicle': 'sedan'}" style="opacity: 1;">I Want a Sedan</a>
                    </div>
</div>
