                                ...
                                ?>
                                  <tr class="">
                                    ...
                                    <td><?php 
                                      ...
                                      if($Assigned)
                                      {
                                        $link =  LEADASSIGNURL . 'profile.php?' . $Encrypt->encrypt('DealerId='.$DealerId.'&Apply=Apply&ContactId='.$ContactId);
                                        echo '
                                          <a class="btn btn-success" href="'.$link.'">Assign</a>
                                        ';
                                      }
                                      else{
                                          $link =  LEADASSIGNURL . 'dealer-profile.php?' . $Encrypt->encrypt('DealerId='.$DealerId);
