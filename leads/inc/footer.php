...
<!-- footer content -->
        <footer>
          <div class="pull-right">
            &copy; Copyright 2016 - <script>document.write(new Date().getFullYear())</script> Car Financing Help | Powered By 
		<a href="http://www.vstudiozzz.com/" target="_blank">Vstudiozzz Edmonton</a>
          </div>
