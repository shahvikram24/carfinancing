      ...
      <div class="main_container">
            ...
            ?>
              ...
              <div class="col-md-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Assigned Leads History <small>Leads which are already assigned to someone</small></h2>
                          ...
                          <tbody>
                            ...
                            <?php
                                  ...
                                  for($x = 0; $x < $Result->TotalResults ; $x++)
                                  {
                                      ...
                                      $link =  ADMINAPPROOT . 'profile.php?' . $Encrypt->encrypt('ContactId='.$Result->Result[$x]['id']);

                                      $dealerpackagefeaturesResultSet = DealerPackageFeatures::LoadFeaturesByContactId($Result->Result[$x]['id'],true);
